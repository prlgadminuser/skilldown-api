...
// Login route
app.post("/login", registerLimiter, async (req, res) => {
  const { username, password } = req.body;
...
app.get("/get-coins/:token", verifyToken, async (req, res) => {
...
app.get("/daily-items/:token", verifyToken, async (req, res) => {
  const token = req.params.token;
...
app.post("/equip-gadget/:token/:gadget", verifyToken, async (req, res) => {
...
app.post("/equip-item1/:token/:itemid", verifyToken, async (req, res) => {
  const { itemid } = req.params;
  const token = req.params.token;
  const username = req.user.username;
...
app.post("/equip-item2/:token/:itemid", verifyToken, async (req, res) => {
  const { itemid } = req.params;
  const token = req.params.token;
  const username = req.user.username;
...
app.post("/equip-banner/:token/:itemid", verifyToken, async (req, res) => {
 const { itemid } = req.params;
  const token = req.params.token;
  const username = req.user.username;
...
app.post("/equip-pose/:token/:itemid", verifyToken, async (req, res) => {
  const { itemid } = req.params;
  const token = req.params.token;
  const username = req.user.username;
...
app.post("/equip-color/:token/:color", verifyToken, async (req, res) => {
...
app.post("/equip-hat-color/:token/:color", verifyToken, async (req, res) => {
  const { color } = req.params;
  const username = req.user.username;
...
app.post("/equip-body-color/:token/:color", verifyToken, async (req, res) => {
  const { color } = req.params;
  const username = req.user.username;
...
app.post("/equip-banner-color/:token/:color", verifyToken, async (req, res) => {
  const { color } = req.params;
  const username = req.user.username;
...
app.post("/reset-equipped-items/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
app.get("/get-user-inventory/:token", verifyToken, async (req, res) => {
  const token = req.params.token;
  const username = req.user.username;
...
app.get("/get-matchstats/:token", verifyToken, async (req, res) => {
...
app.get("/user-profile/:token/:usernamed", verifyToken, async (req, res) => {
...
app.get("/verify-token/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
app.get("/verify-gameservertoken/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
app.get("/global-place/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
app.post("/buy-rarity-box/:token", verifyToken, async (req, res) => {
    const token = req.params.token;
    const username = req.user.username;
    const boxprice = 200;
...
app.post("/upgrade-battle-pass/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
app.post("/claim-login-reward/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
*/
app.post("/send-friend-request/:token/:friendUsername", verifyToken, async (req, res) => {
  const { friendUsername } = req.params;
  const username = req.user.username;
...
app.post("/accept-friend-request/:token/:friendUsername", verifyToken, async (req, res) => {
  const { friendUsername } = req.params;
  const username = req.user.username;
...
app.post("/reject-friend-request/:token/:friendUsername", verifyToken, async (req, res) => {
  const { friendUsername } = req.params;
  const username = req.user.username;
...
app.delete("/delete-friend/:token/:friendUsername", verifyToken, async (req, res) => {
  const { friendUsername } = req.params;
  const username = req.user.username;
...
app.get("/get-friends/:token", verifyToken, async (req, res) => {
  const username = req.user.username;
...
app.get('/events/:token', verifyToken, async (req, res) => {
  const username = req.user.username;
